...
(gtk_accel_path "<Actions>/terminal-window/move-tab-right" "<Primary><Shift><Alt>Right")
...
(gtk_accel_path "<Actions>/terminal-window/move-tab-left" "<Primary><Shift><Alt>Left")
